"use strict";
(() => {
  // .wrangler/tmp/bundle-CW4Upd/checked-fetch.js
...
`
  ...
  // ../../usr/local/share/nvm/versions/node/v20.16.0/lib/node_modules/wrangler/templates/middleware/common.ts
  ...
  // ../../usr/local/share/nvm/versions/node/v20.16.0/lib/node_modules/wrangler/templates/middleware/loader-sw.ts
  ...
  // ../../usr/local/share/nvm/versions/node/v20.16.0/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
  ...
  // ../../usr/local/share/nvm/versions/node/v20.16.0/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
  ...
  // .wrangler/tmp/bundle-CW4Upd/middleware-insertion-facade.js
  __facade_registerInternal__([middleware_ensure_req_body_drained_default, middleware_miniflare3_json_error_default]);

  // src/index.ts
  var SEARCH_LIMIT = 15;
  var HOSTNAME = "https://itunes.apple.com";
  var RESERVED_PARAM_TOPPODCASTS = "toppodcasts";
  var ITUNES_API_GENRES = {
    1301: "Arts",
    1302: "Comedy",
    1303: "Education",
    1304: "Kids & Family",
  ...
  async function searchRequest(query, limit = `${SEARCH_LIMIT}`) {
    if (!query) {
  ...
  async function topRequest(limit = `${SEARCH_LIMIT}`, genre = -1) {
    const genreLookupValue = ITUNES_API_GENRES[genre] ? genre : void 0;
    const TOP_PODCASTS_URL = `${HOSTNAME}/us/rss/${RESERVED_PARAM_TOPPODCASTS}/limit=${limit}/genre=${genreLookupValue}/json`;
  ...
  addEventListener("fetch", (event) => {
    if (event.request.method === "GET") {
      ...
      const query = searchParams.get("q") ?? void 0;
      const limit = searchParams.get("limit") ?? void 0;
      const genre = parseInt(searchParams.get("genre") ?? "-1", 10);
      if (query === RESERVED_PARAM_TOPPODCASTS) {
        const response2 = handleRequest(() => topRequest(limit, genre));
        return event.respondWith(response2);
      }
